...
var CastManager = (function () {
    function CastManager(numberOfPlayers) {
        this.appConfig = null;
    ...
    CastManager.prototype.start = function () {
        this.gameManager.addEventListener(cast.receiver.games.EventType.PLAYER_AVAILABLE, function (event) {
...
var EchoNestClient = (function () {
    function EchoNestClient(apiKey) {
        this.apiKey = apiKey;
        this.spotifyUrl = "https://developer.echonest.com/api/v4";
    }
    EchoNestClient.prototype.searchArtist = function (name) {
        var d = P.defer();
        $.ajax({
